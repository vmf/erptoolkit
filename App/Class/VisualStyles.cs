/*
 * VisualStyles.cs - This file is part of ERPToolkit
...
namespace ERPToolkit.App.Class
{
    ...
    [Guid("4af5b21c-cc04-4beb-ae3f-def3e0000027")]
    [ComVisible(true)]
    public class VisualStyles
    {
        ...
        public void SetCompatibleTextRenderingDefault(bool enabled)
        {
            try
            {
                Application.SetCompatibleTextRenderingDefault(enabled);
            }
            catch (Exception exception)
            {
                var initEx = new ExceptionHandler();
