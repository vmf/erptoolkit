' Font.vbs - This file is part of ERPToolkit
...
'ERPToolkit_Install "C:\PathToTheFontsDirectory\"
public sub ERPToolkit_Install(byval directoryPath)
Dim oFont
	Set oFont = CreateObject("ERPToolkit.Class.Font")
	oFont.Values = GetBasicValues()
	
	'/// <summary>
    '/// Install all fonts from a directory
    '/// </summary>
    '/// <param name="path">Directory that contains the fonts</param>
	oFont.Install directoryPath
end sub
