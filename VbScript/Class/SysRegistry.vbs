' SysRegistry.vbs - This file is part of ERPToolkit
...
'ERPToolkit_CreateLocalIntranet "servername"
public sub ERPToolkit_CreateLocalIntranet(byval rootPath)
Dim oSysRegistry
	Set oSysRegistry = CreateObject("ERPToolkit.Class.SysRegistry")
	'Assigns to the Values object the returned object
	oSysRegistry.Values = GetBasicValues()
	
	'/// <summary>
    '/// Creates a sub key to local intranet and sets its value
    '/// </summary>
    '/// <param name="rootPath">Root path like 'server' for example</param>
	oSysRegistry.CreateLocalIntranet rootPath
end sub
