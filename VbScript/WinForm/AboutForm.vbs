' AboutForm.vbs - This file is part of ERPToolkit
...
ERPToolkit_AboutForm
public sub ERPToolkit_AboutForm()
    Dim oAboutForm
	Set oAboutForm = CreateObject("ERPToolkit.WinForm.AboutForm")
	oAboutForm.Values = GetBasicValues()
