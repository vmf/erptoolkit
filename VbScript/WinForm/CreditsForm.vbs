' CreditsForm.vbs - This file is part of ERPToolkit
...
ERPToolkit_CreditsForm
public sub ERPToolkit_CreditsForm()
Dim oCreditsForm
	Set oCreditsForm = CreateObject("ERPToolkit.WinForm.CreditsForm")
	oCreditsForm.Values = GetBasicValues()
	
	oCreditsForm.ShowDialog
end sub
