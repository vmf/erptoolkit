' MethodInformation.vbs - This file is part of ERPToolkit
...
ERPToolkit_MethodInformation
public sub ERPToolkit_MethodInformation()
Dim oMethodInfo, oSysEnv, oGeneral
    ...
    '/// <returns></returns>
	msgbox(oMethodInfo.GetNumberOfPublicMethods(oSysEnv.GetType))
    ...
    '/// <param name="myType"></param>
    '/// <returns></returns>
	msgbox(oMethodInfo.GetNumberOfNonPublicMethods(oSysEnv.GetType))
    ...
    '/// <param name="myType"></param>
    '/// <returns></returns>
	msgbox(oGeneral.GetStringFromList(oMethodInfo.GetNonPublicMethodInfoList(oSysEnv.GetType()), ";"))
end sub
